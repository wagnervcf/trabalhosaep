    ...
    if ($row > 0) {
        ...
        <div class="modal fade" id="comentar<?php echo $id; ?>" tabindex="-1" aria-labelledby="comentar" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
             ...
             <div class="modal-footer">
              <button type="button" class="btncadastrar" data-bs-target="#inserircomentario<?php echo $id; ?>" data-bs-toggle="modal" data-bs-dismiss="modal">Cadastrar Comentário</button>
              <button type="button" class="btnexcluir" data-bs-dismiss="modal">Cancelar</button>
            </div>
          </div>
        </div>
      </div>
      <div class="modal fade" id="inserircomentario<?php echo $id; ?>" tabindex="-1" aria-labelledby="apagar" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
             ...
             <div class="modal-footer">
             <button type="submit" class="btncadastrar">Cadastrar</button></a>
                </form>
              <button type="button" class="btnexcluir" data-bs-dismiss="modal">Cancelar</button>
            </div>
          </div>
