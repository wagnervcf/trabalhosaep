        ...
        <div class="card-body">
            <form action="login.php" method="POST"  name="senhaform" method="post">
                <div class="form-group">
                    <input type="password" class="form-control" name="senha" size="35" required />
                    <br/>   
        ...
        <fieldset>
          <table id="senhaform">         
             ...
             <tr>
                ...
                <td class="Limpar"><input type="button" name="limpar" class="num2" value="C" onclick="Limpar()" /></td>
                <td><input type="button" name="num0" class="num" value="0" onclick="SenhaNum(0)" /></td>    
                <td class="Entrar"><input type="submit" name="num0" class="num2" value="⤶" onclick="Entrar()" /></td></td>
            </tr>
          </table>
       </fieldset>
                </div>
